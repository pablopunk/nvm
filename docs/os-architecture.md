...
- Selected-text writes report success only after the target app's text reflects the change, and fall back to the clipboard-preserving paste path otherwise; accessibility delivery is not application success.
