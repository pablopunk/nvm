...
- Do not manually prune `@earendil-works/pi-ai` provider dependencies unless the src/backend/desktop contract guarantees which provider adapters are needed.
