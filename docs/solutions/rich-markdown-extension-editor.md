...
- `src/app/palette/markdown-editor.tsx` uses Lexical with the standard Markdown
...
- `src/app/palette/editor-title.ts` derives a plain title from the first non-empty content
