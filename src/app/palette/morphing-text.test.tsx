...
const TORPH_ATTRIBUTE_PATTERN = /torph-/;
...
test('renders a visible base label and one animated span per grapheme', () => {
  ...
  assert.doesNotMatch(markup, TORPH_ATTRIBUTE_PATTERN);
});
