...
test('identifies trusted app and extension window pages', () => {
  ...
  assert.equal(
    isTrustedAppPage('https://example.com/', true, 'http://localhost:5173/'),
    false,
  );
  ...
  assert.equal(
    isTrustedExtensionWindowPage(
      'file:///tmp/evil.html?extensionWindowId=abc%20123',
      'abc 123',
      false,
      '',
      rendererIndexPath,
  ...
  assert.equal(
    isTrustedExtensionWindowPage(
      'http://localhost:5173/?extensionWindowId=abc%20123',
      'abc 123',
      true,
      'http://localhost:5173/',
    ),
  ...
  assert.equal(
    isTrustedExtensionWindowPage(
      'http://localhost:5173.evil.test/?extensionWindowId=abc%20123',
      'abc 123',
      true,
      'http://localhost:5173/',
    ),
  ...
  assert.equal(
    isTrustedExtensionWindowPage(
      'http://localhost:5173/?extensionWindowId=other',
      'abc 123',
      true,
      'http://localhost:5173/',
    ),
