...
function capabilities() {
  return {
    ...
    files: ['ctx.desktop.files.metadata(path) returns canonical metadata and host-safe URLs; ctx.desktop.files.thumbnail(path) returns a thumbnail URL for previewable image/video paths'], 
