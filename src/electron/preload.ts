...
const api: NevermindApi = {
  ...
  refreshView: (input) => ipcRenderer.invoke('view:refresh', input),
  ...
  tweakExtension: (input) => ipcRenderer.invoke('ai-builder:tweak-extension', input),
  startBuilderChat: (input) => ipcRenderer.invoke('ai-builder:start-chat', input),
