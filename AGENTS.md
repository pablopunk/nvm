...
* Before committing palette/extension API migrations, verify representative user flows in addition to tests: open view, run primary action, run action-panel action, preserve selection, icons/media, and dismissal behavior.
