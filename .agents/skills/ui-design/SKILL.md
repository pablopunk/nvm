...
- **Constrained scales.** Use a fixed spacing scale (4/8/12/16/24/32/48/64) and a modular type scale (12/14/16/20/24/30/36). No arbitrary values.
- **Generous whitespace.** Start with too much, then remove. Dense feels cheap; airy feels premium.
