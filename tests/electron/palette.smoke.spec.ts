// biome-ignore-all lint: End-to-end Electron harness intentionally uses dynamic page payloads, polling, process cleanup primitives, injected environment names, and bounded process control.
