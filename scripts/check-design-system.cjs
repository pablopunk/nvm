...
assertIncludes('src/electron/main.cjs', "presentation: 'root'")
assertIncludes('src/electron/main.cjs', 'function clipboardHistoryView()')
...
assertIncludes('src/electron/main.cjs', 'case \'nativeAction\'')
assertIncludes('src/electron/main.cjs', 'declaredGlobalShortcuts')
